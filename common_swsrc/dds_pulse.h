...
inline const char* DDS_name(unsigned iDDS)
{
	switch (iDDS)
	{
	case DDS_DOPPLER_B1:	return "  Doppler B1";
	case DDS_DOPPLER_B2:	return "  Doppler B2";
	case DDS_DOPPLER_B3:	return "  Doppler B3";
	default:           	return "  unknown";
	}
}
...
inline const char* DDS_name(unsigned iDDS)
{
	switch (iDDS)
	{
        case  DDS_BURNER:   return "  Burner";
        case  DDS_CAVITY:   return "  Cavity";
        case DDS_BURNER2:   return " Burner2";
	default:            return "  unknown";
