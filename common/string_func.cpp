...
template<> void get_sprintf_fmt(char* s, const int*)
{
    strcpy(s, "%d");
}
template<> void get_sprintf_fmt(char* s, const unsigned*)
{
    strcpy(s, "%u");
}
template<> void get_sprintf_fmt(char* s, const double*)
{
    strcpy(s, "%.15g");
}
...
template<> std::string from_string<std::string>(const std::string& s)
{
    return s;
}
...
template<> void get_sscanf_fmt(char* s, unsigned*)
{
    strcpy(s, "%u");
}
template<> void get_sscanf_fmt(char* s, double*)
{
    strcpy(s, "%lf");
}
template<> void get_sscanf_fmt(char* s, std::string*)
{
    strcpy(s, "%s");
}
